...
def main():
    curve_path = """/Users/carterr/Documents/afm_andy/LE Mannitol 010316 Sample 1/Le Mannitol 010316 sample 1 map-data-2016.03.01-15.09.41.098_processed-2016.03.02-10.20.03/Le Mannitol 010316 sample 1 map-data-2016.03.01-15.09.41.098_00367.txt"""
    ...
    map1.plot_stiffness_hist()
    map1.plot_stiffness_map()
    map1.plot_height_map()
    map1.plot_hertz_map()
    map1.plot_sneddon_map()
